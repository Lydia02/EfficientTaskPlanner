...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const displayTasks = (section, tasksToDisplay) => {
        ...
        const filteredTasks = tasksToRender.filter((task) => {
            switch (section) {
                case "tasksfortheDay":
                    titleLink.textContent = "Tasks for the Day";
                    return task.date === todayDate;
                case "tasksfortheWeek":
    ...
    function promptForNameAndEmail() {
        swal({
            title: "Welcome to Efficient Task Planner. Kindly enter your information",
            content: {
                element: "div",
                attributes: {
                    innerHTML: `
...
myDayLink.addEventListener("click", function () { handleSectionLinkClick("tasksfortheDay", myDayLink); });
thisWeekLink.addEventListener("click", function () { handleSectionLinkClick("tasksfortheWeek", thisWeekLink); });
thisMonthLink.addEventListener("click", function () { handleSectionLinkClick("tasksfortheMonth", thisMonthLink); });
otherLink.addEventListener("click", function () { handleSectionLinkClick("other", otherLink); });

    let currentSection = "tasksfortheDay";
    displayTasks(currentSection);
